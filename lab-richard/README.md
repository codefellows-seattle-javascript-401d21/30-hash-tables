...
<h2>About</h2>
Hash Table data structure includes methods:

hashKey(key) - Creates a Hashed Key to in the Hash Table Array

set(key, value) - Adds nodes to the Hash Table

get(key) - Retrieves nodes from the Hash Table using a Key

remove(key) - Removes a node from the Hash Table using its key
